...
function mixFood(leastSpicyFood, secondSpicyFood) {
  return leastSpicyFood + secondSpicyFood * 2;
}
...
function solution(scoville, K) {
  ...
  while (minHeap.peek() < K) {
    ...
    const leastSpicyFood = minHeap.pop();
    const secondSpicyFood = minHeap.pop();

    const newFood = mixFood(leastSpicyFood, secondSpicyFood);
    answer++;
